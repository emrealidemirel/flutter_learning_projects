...
class Sabitler {
  ...
  static final TextStyle baslikStil = GoogleFonts.quicksand(
  ...
  static final dropDownPadding = EdgeInsets.symmetric(horizontal: 10);

  static final yatayPadding7 = EdgeInsets.symmetric(horizontal: 7);
}
